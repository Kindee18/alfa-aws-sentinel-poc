...
def lambda_handler(event, context):
    print("🚀 Alfa Operations Sentinel: Incident Detected!")
    ...
    try:
        ...
        print(f"⚠️ Incident: Health Check Failure on {instance_id}")
        print("🤖 Action: Triggering automated instance reboot...")
